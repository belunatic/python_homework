...
class Board:
    ...
    # So __str__ controls what gets printed, 
    # how this object be printed when print(BoardClass) is called
    def __str__(self):
        lines=[]
    ...
    def move(self, move_string):
        ...
        # returns the position (index number) of the first occurrence of that value in the list.
...
first_move = input("Enter your move (upper left, upper center, upper right, middle left, center, middle right, lower left, lower center, lower right): ")

while True:
    try:
        tic_tac_toe.move(first_move)
        print(tic_tac_toe)
        game_over, message = tic_tac_toe.whats_next()
        print(message)
        if game_over:
            break
        first_move = input("Enter your move (upper left, upper center, upper right, middle left, center, middle right, lower left, lower center, lower right): ")
